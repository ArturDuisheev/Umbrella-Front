      ...
      <div className="our-approach-content container">
        <div className="our-approach-content-wrapper">
          ...
          <p className="our-approach-content-wrapper-text" style={{ marginBottom: '25px' }}>
            Наша философия в Umbrella — сначала понять ваш бизнес, чтобы предложить решения,
            которые действительно работают именно для вас.
            Подход <b>"Зонтичное решение"</b> позволяет разрабатывать стратегии по платному продвижению,
            которые соответствуют вашим целям и обеспечивают максимальную окупаемость инвестиций.
