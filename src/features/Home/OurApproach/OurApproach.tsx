      ...
      <div className="our-approach-content container">
        <div className="our-approach-content-wrapper">
          ...
          <p className="our-approach-content-wrapper-text" style={{ marginBottom: '25px' }}>
            Мы называем наш подход <b>«зонтичным решением»</b>, когда через детальную диагностику вашего бизнеса мы
            разрабатываем уникальные стратегии продвижения, которые точно соответствуют вашим потребностям и целям.
            <br />
            <br />
            Мы тщательно анализируем вашу целевую аудиторию, выявляем её драйверы и «боли» и <b>создаём решения, которые
            эффективно и правильно адресуют нужную коммуникацию.</b>
          </p>
